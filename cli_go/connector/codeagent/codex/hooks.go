...
// globalConfigPath returns ~/.codex/config.yaml.
...
// ============================================================
// Global config.yaml read / write
// ============================================================

// readGlobalConfig reads ~/.codex/config.yaml into a key→value map.
...
// writeGlobalConfig serialises cfg to ~/.codex/config.yaml.
...
// ============================================================
// Sandbox flag ↔ *sandbox.Sandbox
// ============================================================

// sandboxFromFlag reconstructs a *sandbox.Sandbox from the stored config flag value.
