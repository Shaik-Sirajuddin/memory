...
Complex nested values (`sandbox.Sandbox`) are JSON-serialised in-place. Primitive and flat values (model provider/name) use direct SQLite columns for easier querying and to avoid unmarshalling overhead.
